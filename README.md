...
dependencies {
    ...
    testImplementation("dev.s7a:fiktion-addon-arrow-core:0.6.3")

    // Optional: common JVM types such as Instant, UUID, URI, and Java collections.
    testImplementation("dev.s7a:fiktion-addon-java:0.6.3")

    // Optional: kotlinx-datetime types such as LocalDate, LocalDateTime, and TimeZone.
    testImplementation("dev.s7a:fiktion-addon-kotlinx-datetime:0.6.3")
...
Fiktion `0.6.3` is built with Kotlin `2.4.0` and supports consumer projects using Kotlin `2.4.x`.
